...
def onehot_encode(df,data_path_1,flag='train'):
    ...
    if flag == 'train':
        ...
        df_return.columns = enc.get_feature_names_out(df.columns)
        ...
        df_return.columns = onehot_model.get_feature_names_out(df.columns)
...
if __name__ == '__main__':
    path = 'C:\\Users\\98128\\Desktop\\量化相关\\职业规划\\credit_risk_portfolio\\demo\\variable_encode'
